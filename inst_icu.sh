!/bin/bash
cd /home
apt update && apt install -y usbmuxd libimobiledevice-1.0-6 libimobiledevice-utils libavahi-compat-libdnssd-dev curl wget procps usbutils lsof tmux build-essential \
